...
export class EditCustomerComponent implements OnInit {
  ...
  editCustomer() {
    ...
    this.customerService.editCustomer(customer).subscribe(() => {
      this.toastrService.info('Cập nhật khách hàng thành công!!!');
  ...
  private findCustomer() {
      ...
      this.customerService.findById(this.customerId).subscribe(data2 => {
        console.log(data2);
  ...
  compareFn(c1: any, c2: any): boolean {    return c1 && c2 ? c1.unitId === c2.unitId : c1 === c2;  }
}
